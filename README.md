...
뭘 적어야 할 지 몰라서 수정 좀 해주세요...

셰프는 셰프로 가입하여 강좌를 개설하고 동영상 레시피를 업로드 할 수 있습니다. 본인의 강좌, 레시피만을 편집, 삭제할 수 있습니다.
...
## :cocktail: <strong>Use Case Diagram</strong>

유즈 케이스 다이어 그램 이미지 or 링크 추가
